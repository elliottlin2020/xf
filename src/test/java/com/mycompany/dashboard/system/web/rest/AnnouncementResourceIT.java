...
import com.mycompany.dashboard.domain.enumeration.AnnoBusinessType;
import com.mycompany.dashboard.domain.enumeration.AnnoCategory;
import com.mycompany.dashboard.domain.enumeration.AnnoOpenType;
import com.mycompany.dashboard.domain.enumeration.AnnoSendStatus;
import com.mycompany.dashboard.domain.enumeration.PriorityLevel;
...
public class AnnouncementResourceIT {
    ...
    void createAnnouncement() throws Exception {
        ...
        restAnnouncementMockMvc
            .perform(
                post(ENTITY_API_URL_ID, announcementDTO.getId())
    ...
    @Test
    @Transactional
    void putNonExistingngAnnouncement() throws Exception {
        int databaseSizeBeforeUpdate = announcementRepository.findAll().size();
