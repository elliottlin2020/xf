...
public class DataPermissionRuleResourceIT {
    ...
    void createDataPermissionRule() throws Exception {
        ...
        restDataPermissionRuleMockMvc
            .perform(
                post(ENTITY_API_URL_ID, dataPermissionRuleDTO.getId())
    ...
    @Test
    @Transactional
    public void getAllDataPermissionRules() throws Exception {
    ...
    @Test
    @Transactional
    public void getDataPermissionRule() throws Exception {
        // Initialize the database
        dataPermissionRuleRepository.insert(dataPermissionRule);
    ...
    @Test
    @Transactional
    public void getDataPermissionRulesByIdFiltering() throws Exception {
        // Initialize the database
        dataPermissionRuleRepository.insert(dataPermissionRule);
    ...
    @Test
    @Transactional
    void putNonExistingngDataPermissionRule() throws Exception {
        int databaseSizeBeforeUpdate = dataPermissionRuleRepository.findAll().size();
    ...
    void partialUpdateDataPermissionRuleWithPatch() throws Exception {
        ...
        partialUpdatedDataPermissionRule.name(UPDATED_NAME);
