...
import com.mycompany.dashboard.domain.enumeration.SendStatus;
...
public class SmsMessageResourceIT {
    ...
    void createSmsMessage() throws Exception {
        ...
        restSmsMessageMockMvc
            .perform(
                post(ENTITY_API_URL_ID, smsMessageDTO.getId())
    ...
    @Test
    @Transactional
    public void getAllSmsMessages() throws Exception {
    ...
    @Test
    @Transactional
    public void getSmsMessagesByIdFiltering() throws Exception {
        // Initialize the database
        smsMessageRepository.insert(smsMessage);
    ...
    @Test
    @Transactional
    void putNonExistingngSmsMessage() throws Exception {
        int databaseSizeBeforeUpdate = smsMessageRepository.findAll().size();
    ...
    void partialUpdateSmsMessageWithPatch() throws Exception {
        ...
        partialUpdatedSmsMessage.sendType(UPDATED_SEND_TYPE).params(UPDATED_PARAMS).content(UPDATED_CONTENT).remark(UPDATED_REMARK);
