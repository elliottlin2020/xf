...
public class AnnouncementRecordResourceIT {
    ...
    void createAnnouncementRecord() throws Exception {
        ...
        restAnnouncementRecordMockMvc
            .perform(
                post(ENTITY_API_URL_ID, announcementRecordDTO.getId())
    ...
    @Test
    @Transactional
    public void getAllAnnouncementRecords() throws Exception {
    ...
    @Test
    @Transactional
    public void getAnnouncementRecord() throws Exception {
        // Initialize the database
        announcementRecordRepository.insert(announcementRecord);
    ...
    @Test
    @Transactional
    public void getAnnouncementRecordsByIdFiltering() throws Exception {
        // Initialize the database
        announcementRecordRepository.insert(announcementRecord);
    ...
    @Test
    @Transactional
    void putNonExistingngAnnouncementRecord() throws Exception {
        int databaseSizeBeforeUpdate = announcementRecordRepository.findAll().size();
