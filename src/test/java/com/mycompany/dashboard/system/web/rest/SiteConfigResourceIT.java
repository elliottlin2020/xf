...
public class SiteConfigResourceIT {
    ...
    void createSiteConfig() throws Exception {
        ...
        restSiteConfigMockMvc
            .perform(
                post(ENTITY_API_URL_ID, siteConfigDTO.getId())
    ...
    @Test
    @Transactional
    public void getAllSiteConfigs() throws Exception {
    ...
    @Test
    @Transactional
    public void getSiteConfig() throws Exception {
        // Initialize the database
        siteConfigRepository.insert(siteConfig);
    ...
    @Test
    @Transactional
    public void getSiteConfigsByIdFiltering() throws Exception {
        // Initialize the database
        siteConfigRepository.insert(siteConfig);
    ...
    @Test
    @Transactional
    void putNonExistingngSiteConfig() throws Exception {
        int databaseSizeBeforeUpdate = siteConfigRepository.findAll().size();
    ...
    void partialUpdateSiteConfigWithPatch() throws Exception {
        ...
        partialUpdatedSiteConfig.fieldName(UPDATED_FIELD_NAME).fieldType(UPDATED_FIELD_TYPE);
