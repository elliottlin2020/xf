...
import com.mycompany.dashboard.domain.enumeration.ApiPermissionType;
...
public class ApiPermissionResourceIT {
    ...
    void partialUpdateApiPermissionWithPatch() throws Exception {
        ...
        partialUpdatedApiPermission.serviceName(UPDATED_SERVICE_NAME).code(UPDATED_CODE).type(UPDATED_TYPE).url(UPDATED_URL);
