...
import com.mycompany.dashboard.domain.RegionCode;
import com.mycompany.dashboard.domain.enumeration.RegionCodeLevel;
...
public class RegionCodeResourceIT {
    ...
    void createRegionCode() throws Exception {
        ...
        restRegionCodeMockMvc
            .perform(
                post(ENTITY_API_URL_ID, regionCodeDTO.getId())
    ...
    @Test
    @Transactional
    public void getAllRegionCodes() throws Exception {
    ...
    @Test
    @Transactional
    public void getRegionCode() throws Exception {
        // Initialize the database
        regionCodeRepository.insert(regionCode);
    ...
    @Test
    @Transactional
    public void getRegionCodesByIdFiltering() throws Exception {
        // Initialize the database
        regionCodeRepository.insert(regionCode);
    ...
    @Test
    @Transactional
    public void getAllRegionCodesByChildrenIsEqualToSomething() throws Exception {
        // Initialize the database
        regionCodeRepository.insert(regionCode);
    ...
    @Test
    @Transactional
    public void getAllRegionCodesByParentIsEqualToSomething() throws Exception {
        // Initialize the database
        regionCodeRepository.insert(regionCode);
    ...
    @Test
    @Transactional
    void putNonExistingngRegionCode() throws Exception {
        int databaseSizeBeforeUpdate = regionCodeRepository.findAll().size();
    ...
    void partialUpdateRegionCodeWithPatch() throws Exception {
        ...
        partialUpdatedRegionCode.name(UPDATED_NAME).mergerName(UPDATED_MERGER_NAME).zipCode(UPDATED_ZIP_CODE).lat(UPDATED_LAT);
