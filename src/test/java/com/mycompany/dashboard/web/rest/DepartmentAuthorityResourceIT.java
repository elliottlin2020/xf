...
import static com.mycompany.dashboard.web.rest.TestUtil.createFormattingConversionService;
import static com.mycompany.dashboard.web.rest.TestUtil.sameInstant;
import static com.mycompany.dashboard.web.rest.TestUtil.sameInstant;
...
import com.mycompany.dashboard.DashboardApp;
import com.mycompany.dashboard.IntegrationTest;
...
import com.mycompany.dashboard.web.rest.errors.ExceptionTranslator;
...
@WithMockUser
public class DepartmentAuthorityResourceIT {
    ...
    void createDepartmentAuthority() throws Exception {
        ...
        restDepartmentAuthorityMockMvc
            .perform(
                post(ENTITY_API_URL_ID, departmentAuthorityDTO.getId())
    ...
    @Test
    @Transactional
    public void getAllDepartmentAuthorities() throws Exception {
    ...
    @Test
    @Transactional
    public void getDepartmentAuthority() throws Exception {
        // Initialize the database
        departmentAuthorityRepository.insert(departmentAuthority);
    ...
    @Test
    @Transactional
    public void getDepartmentAuthoritiesByIdFiltering() throws Exception {
        // Initialize the database
        departmentAuthorityRepository.insert(departmentAuthority);
    ...
    @Test
    @Transactional
    public void getAllDepartmentAuthoritiesByUsersIsEqualToSomething() throws Exception {
        // Initialize the database
        departmentAuthorityRepository.insert(departmentAuthority);
    ...
    @Test
    @Transactional
    public void getAllDepartmentAuthoritiesByApiPermissionsIsEqualToSomething() throws Exception {
        // Initialize the database
        departmentAuthorityRepository.insert(departmentAuthority);
    ...
    @Test
    @Transactional
    public void getAllDepartmentAuthoritiesByViewPermissionsIsEqualToSomething() throws Exception {
        // Initialize the database
        departmentAuthorityRepository.insert(departmentAuthority);
    ...
    @Test
    @Transactional
    public void getAllDepartmentAuthoritiesByDepartmentIsEqualToSomething() throws Exception {
        // Initialize the database
        departmentAuthorityRepository.insert(departmentAuthority);
    ...
    @Test
    @Transactional
    void putNonExistingngDepartmentAuthority() throws Exception {
        int databaseSizeBeforeUpdate = departmentAuthorityRepository.findAll().size();
