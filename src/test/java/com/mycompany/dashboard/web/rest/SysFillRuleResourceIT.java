...
public class SysFillRuleResourceIT {
    ...
    void createSysFillRule() throws Exception {
        ...
        restSysFillRuleMockMvc
            .perform(
                post(ENTITY_API_URL_ID, sysFillRuleDTO.getId())
    ...
    @Test
    @Transactional
    public void getAllSysFillRules() throws Exception {
    ...
    @Test
    @Transactional
    public void getSysFillRule() throws Exception {
        // Initialize the database
        sysFillRuleRepository.insert(sysFillRule);
    ...
    @Test
    @Transactional
    public void getSysFillRulesByIdFiltering() throws Exception {
        // Initialize the database
        sysFillRuleRepository.insert(sysFillRule);
    ...
    @Test
    @Transactional
    void putNonExistingngSysFillRule() throws Exception {
        int databaseSizeBeforeUpdate = sysFillRuleRepository.findAll().size();
    ...
    void partialUpdateSysFillRuleWithPatch() throws Exception {
        ...
        partialUpdatedSysFillRule.params(UPDATED_PARAMS);
