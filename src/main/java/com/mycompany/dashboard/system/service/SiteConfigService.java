...
public class SiteConfigService extends BaseServiceImpl<SiteConfigRepository, SiteConfig> {
    ...
    public SiteConfigDTO save(SiteConfigDTO siteConfigDTO) {
        ...
        return siteConfigMapper.toDto(this.getById(siteConfig.getId()));
    }
    ...
    public SiteConfigDTO updateBySpecifiedFields(SiteConfigDTO changeSiteConfigDTO, Set<String> fieldNames) {
        ...
        fieldNames.forEach(
            fieldName -> {
                updateWrapper.set(fieldName, BeanUtil.getFieldValue(changeSiteConfigDTO, fieldName));
            }
        );
    ...
    public SiteConfigDTO updateBySpecifiedField(SiteConfigDTO changeSiteConfigDTO, String fieldName) {
        SiteConfigDTO updateDTO = new SiteConfigDTO();
        BeanUtil.setFieldValue(updateDTO, "id", changeSiteConfigDTO.getId());
        BeanUtil.setFieldValue(updateDTO, fieldName, BeanUtil.getFieldValue(changeSiteConfigDTO, fieldName));
        this.updateEntity(siteConfigMapper.toEntity(updateDTO));
        return findOne(changeSiteConfigDTO.getId()).get();
    }
