...
public class AnnouncementQueryService implements QueryService<Announcement> {
        ...
        if (criteria != null) {
            if (StringUtils.isNotEmpty(criteria.getJhiCommonSearchKeywords())) {
                ...
                if (criteria.getTitile() != null) {
                    queryWrapper = queryWrapper.and(buildStringSpecification(criteria.getTitile(), "titile"));
                }
                if (criteria.getStartTime() != null) {
                    queryWrapper = queryWrapper.and(buildRangeSpecification(criteria.getStartTime(), "start_time"));
                }
                if (criteria.getEndTime() != null) {
                    queryWrapper = queryWrapper.and(buildRangeSpecification(criteria.getEndTime(), "end_time"));
                }
                if (criteria.getSenderId() != null) {
                    queryWrapper = queryWrapper.and(buildRangeSpecification(criteria.getSenderId(), "sender_id"));
                }
                if (criteria.getPriority() != null) {
                    queryWrapper = queryWrapper.and(buildSpecification(criteria.getPriority(), "priority"));
                }
                if (criteria.getCategory() != null) {
                    queryWrapper = queryWrapper.and(buildSpecification(criteria.getCategory(), "category"));
                }
                if (criteria.getReceiverType() != null) {
                    queryWrapper = queryWrapper.and(buildSpecification(criteria.getReceiverType(), "receiver_type"));
                }
                ...
                if (criteria.getCancelTime() != null) {
                    queryWrapper = queryWrapper.and(buildRangeSpecification(criteria.getCancelTime(), "cancel_time"));
                }
                if (criteria.getBusinessType() != null) {
                    queryWrapper = queryWrapper.and(buildSpecification(criteria.getBusinessType(), "business_type"));
                }
                if (criteria.getBusinessId() != null) {
                    queryWrapper = queryWrapper.and(buildRangeSpecification(criteria.getBusinessId(), "business_id"));
                }
                if (criteria.getOpenType() != null) {
                    queryWrapper = queryWrapper.and(buildSpecification(criteria.getOpenType(), "open_type"));
                }
                if (criteria.getOpenPage() != null) {
                    queryWrapper = queryWrapper.and(buildStringSpecification(criteria.getOpenPage(), "open_page"));
                }
                if (criteria.getReceiverIds() != null) {
                    queryWrapper = queryWrapper.and(buildSpecification(criteria.getReceiverIds(), "receiver_ids"));
                }
     ...
     * @param pageable 分页
     * @return Page<AnnouncementDTO>
     */
    @Transactional(readOnly = true)
    public Page<AnnouncementDTO> selectByCustomEntity(
        String entityName,
        ...
        // DynamicJoinQueryWrapper<Announcement, Announcement> dynamicJoinQueryWrapper = new DynamicJoinQueryWrapper<>(Announcement.class, dynamicRelationships);
        ...
        List<AnnouncementDTO> result = dynamicJoinQueryWrapper
            .queryList(Announcement.class, pagination)
            .stream()
            .peek(Binder::bindRelations)
            .map(announcementMapper::toDto)
            .collect(Collectors.toList());
        return new Page<AnnouncementDTO>(pagination.getPageIndex(), pagination.getPageSize(), pagination.getTotalCount())
            .setRecords(result);
    }
}
