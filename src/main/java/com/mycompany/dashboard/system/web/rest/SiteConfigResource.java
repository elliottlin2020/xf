 ...
 * 管理实体{@link com.mycompany.dashboard.system.domain.SiteConfig}的REST Controller。
 */
@RestController
@RequestMapping("/api")
...
public class SiteConfigResource {
    ...
    public ResponseEntity<Void> exportToExcel() throws IOException {
        ...
        Workbook workbook = ExcelExportUtil.exportExcel(new ExportParams("计算机一班学生", "学生"), SiteConfigDTO.class, page.getRecords());
