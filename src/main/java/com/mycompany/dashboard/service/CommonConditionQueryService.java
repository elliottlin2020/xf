...
import com.mycompany.dashboard.anltr.CriteriaLogicExprListener;
import com.mycompany.dashboard.anltr.LogicExprLexer;
import com.mycompany.dashboard.anltr.LogicExprParser;
...
import com.mycompany.dashboard.service.mapper.CommonConditionMapper;
...
public class CommonConditionQueryService
    extends DynamicJoinQueryWrapper<CommonCondition, CommonCondition>
    implements QueryService<CommonCondition> {
    ...
    protected <X extends Comparable<? super X>> MergeSegments buildRangeMergeSegments(RangeFilter<X> filter, String field) {
        ...
        if (filter.getLessThan() != null) {
            mergeSegments.add(() -> String.valueOf(field), LT, () -> String.valueOf(filter.getLessThan()));
        }
        if (filter.getLessThanOrEqual() != null) {
            mergeSegments.add(() -> String.valueOf(field), LE, () -> String.valueOf(filter.getLessThanOrEqual()));
        }
