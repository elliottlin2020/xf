...
import com.mycompany.dashboard.service.mapper.DepartmentMapper;
...
public class DepartmentQueryService implements QueryService<Department> {
        ...
        if (criteria != null) {
            if (StringUtils.isNotEmpty(criteria.getJhiCommonSearchKeywords())) {
                ...
                if (criteria.getPhoneNum() != null) {
                    queryWrapper = queryWrapper.and(buildStringSpecification(criteria.getPhoneNum(), "phone_num"));
                }
                if (criteria.getLogo() != null) {
                    queryWrapper = queryWrapper.and(buildStringSpecification(criteria.getLogo(), "logo"));
                }
                if (criteria.getContact() != null) {
                    queryWrapper = queryWrapper.and(buildStringSpecification(criteria.getContact(), "contact"));
                }
                ...
                if (criteria.getParentName() != null) {
                    queryWrapper = queryWrapper.and(buildStringSpecification(criteria.getParentName(), "department_left_join.name"));
                }
    ...
    public Page<DepartmentDTO> selectByCustomEntity(
        ...
        List<DepartmentDTO> result = dynamicJoinQueryWrapper
            .queryList(Department.class, pagination)
            .stream()
