...
public class ApiPermissionService extends BaseServiceImpl<ApiPermissionRepository, ApiPermission> {
    ...
    private final List<String> relationCacheNames = Arrays.asList(
        com.mycompany.dashboard.domain.ApiPermission.class.getName() + ".parent",
        com.mycompany.dashboard.domain.ApiPermission.class.getName() + ".children" //,
        // com.mycompany.dashboard.domain.ViewPermission.class.getName() + ".apiPermissions"
    );
    ...
    private void clearChildrenCache() {
        Objects.requireNonNull(cacheManager.getCache(com.mycompany.dashboard.domain.ApiPermission.class.getName() + ".children")).clear();
    }
