...
public class ViewPermissionService extends BaseServiceImpl<ViewPermissionRepository, ViewPermission> {
    ...
    private final List<String> relationCacheNames = Arrays.asList(
        com.mycompany.dashboard.domain.ViewPermission.class.getName() + ".parent",
        com.mycompany.dashboard.domain.ApiPermission.class.getName() + ".viewPermissions",
        com.mycompany.dashboard.domain.ViewPermission.class.getName() + ".children",
        com.mycompany.dashboard.domain.Authority.class.getName() + ".viewPermission"
    );
    ...
    private void clearChildrenCache() {
        Objects.requireNonNull(cacheManager.getCache(com.mycompany.dashboard.domain.ViewPermission.class.getName() + ".children")).clear();
    }
