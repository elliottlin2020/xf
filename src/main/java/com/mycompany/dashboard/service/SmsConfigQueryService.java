...
import com.mycompany.dashboard.service.mapper.SmsConfigMapper;
...
public class SmsConfigQueryService implements QueryService<SmsConfig> {
        ...
        if (criteria != null) {
            if (StringUtils.isNotEmpty(criteria.getJhiCommonSearchKeywords())) {
                ...
                if (criteria.getSmsCode() != null) {
                    queryWrapper = queryWrapper.and(buildStringSpecification(criteria.getSmsCode(), "sms_code"));
                }
                if (criteria.getTemplateId() != null) {
                    queryWrapper = queryWrapper.and(buildStringSpecification(criteria.getTemplateId(), "template_id"));
                }
                ...
                if (criteria.getRegionId() != null) {
                    queryWrapper = queryWrapper.and(buildStringSpecification(criteria.getRegionId(), "region_id"));
                }
                if (criteria.getSignName() != null) {
                    queryWrapper = queryWrapper.and(buildStringSpecification(criteria.getSignName(), "sign_name"));
                }
    ...
    public Page<SmsConfigDTO> selectByCustomEntity(
        ...
        List<SmsConfigDTO> result = dynamicJoinQueryWrapper
            .queryList(SmsConfig.class, pagination)
            .stream()
