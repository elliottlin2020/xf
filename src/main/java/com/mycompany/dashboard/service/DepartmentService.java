...
public class DepartmentService extends BaseServiceImpl<DepartmentRepository, Department> {
    ...
    private final List<String> relationCacheNames = Arrays.asList(
        com.mycompany.dashboard.domain.Department.class.getName() + ".parent",
        com.mycompany.dashboard.domain.Authority.class.getName() + ".departments",
        com.mycompany.dashboard.domain.Department.class.getName() + ".children",
        com.mycompany.dashboard.domain.User.class.getName() + ".department",
        com.mycompany.dashboard.domain.DepartmentAuthority.class.getName() + ".department"
    );
            ...
            .convert(
                department -> {
                    Binder.bindRelations(
                        department,
                        new String[] { "children", "authorities", "parent", "users", "departmentAuthorities" }
                    );
                    return departmentMapper.toDto(department);
                }
            );
    ...
    private void clearChildrenCache() {
        Objects.requireNonNull(cacheManager.getCache(com.mycompany.dashboard.domain.Department.class.getName() + ".children")).clear();
    }
