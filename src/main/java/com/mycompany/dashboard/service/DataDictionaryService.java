...
public class DataDictionaryService extends BaseServiceImpl<DataDictionaryRepository, DataDictionary> {
    ...
    private final List<String> relationCacheNames = Arrays.asList(
        com.mycompany.dashboard.domain.DataDictionary.class.getName() + ".parent",
        com.mycompany.dashboard.domain.DataDictionary.class.getName() + ".children"
    );
    ...
    private void clearChildrenCache() {
        Objects.requireNonNull(cacheManager.getCache(com.mycompany.dashboard.domain.DataDictionary.class.getName() + ".children")).clear();
    }
