...
public class AuthorityService extends BaseServiceImpl<AuthorityRepository, Authority> {
    ...
    private final List<String> relationCacheNames = Arrays.asList(
        com.mycompany.dashboard.domain.Authority.class.getName() + ".parent",
        com.mycompany.dashboard.domain.User.class.getName() + ".authority",
        com.mycompany.dashboard.domain.ViewPermission.class.getName() + ".authorities",
        com.mycompany.dashboard.domain.Authority.class.getName() + ".children"
    );
    ...
    private void clearChildrenCache() {
        Objects.requireNonNull(cacheManager.getCache(com.mycompany.dashboard.domain.Authority.class.getName() + ".children")).clear();
    }
