...
public class ResourceCategoryService extends BaseServiceImpl<ResourceCategoryRepository, ResourceCategory> {
    ...
    private final List<String> relationCacheNames = Arrays.asList(
        com.mycompany.dashboard.domain.UploadFile.class.getName() + ".category",
        com.mycompany.dashboard.domain.ResourceCategory.class.getName() + ".parent",
        com.mycompany.dashboard.domain.UploadImage.class.getName() + ".category",
        com.mycompany.dashboard.domain.ResourceCategory.class.getName() + ".children"
    );
    ...
    private void clearChildrenCache() {
        Objects
            .requireNonNull(cacheManager.getCache(com.mycompany.dashboard.domain.ResourceCategory.class.getName() + ".children"))
            .clear();
    }
