...
import com.mycompany.dashboard.service.CommonTableFieldQueryService;
import com.mycompany.dashboard.service.CommonTableFieldService;
 ...
 * 管理实体{@link com.mycompany.dashboard.domain.CommonTableField}的REST Controller。
 */
@RestController
@RequestMapping("/api")
@Api(value = "common-table-fields", tags = "模型字段API接口")
public class CommonTableFieldResource {
    ...
    @ApiOperation(value = "新建模型字段", notes = "创建并返回一个新的模型字段")
    ...
    @ApiOperation(value = "更新模型字段", notes = "根据主键更新并返回一个更新后的模型字段")
    public ResponseEntity<CommonTableFieldDTO> updateCommonTableField(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, commonTableFieldDTO.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @ApiOperation(value = "部分更新模型字段", notes = "根据主键及实体信息实现部分更新，值为null的属性将忽略，并返回一个更新后的模型字段")
    ...
    public ResponseEntity<CommonTableFieldDTO> partialUpdateCommonTableField(
        ...
        if (commonTableFieldRepository.findById(id).isEmpty()) {
            throw new BadRequestAlertException("Entity not found", ENTITY_NAME, "idnotfound");
        }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, commonTableFieldDTO.getId().toString())
        );
    }
    ...
    @ApiOperation(value = "获取模型字段分页列表", notes = "获取模型字段的分页列表数据")
    ...
    @ApiOperation(value = "获取指定主键的模型字段", notes = "获取指定主键的模型字段信息")
    ...
    @ApiOperation(value = "模型字段EXCEL导出", notes = "导出全部模型字段为EXCEL文件")
    ...
    @ApiOperation(value = "模型字段EXCEL导入", notes = "根据模型字段EXCEL文件导入全部数据")
    ...
    @ApiOperation(value = "删除一个模型字段", notes = "根据主键删除单个模型字段")
    ...
    @ApiOperation(value = "删除多个模型字段", notes = "根据主键删除多个模型字段")
    ...
    @ApiOperation(value = "根据字段部分更新模型字段", notes = "根据指定字段部分更新模型字段，给定的属性值可以为任何值，包括null")
    ...
    @ApiOperation(value = "更新模型字段单个属性", notes = "根据指定字段更新模型字段，给定的属性值可以为任何值，包括null")
