...
import com.mycompany.dashboard.service.GpsInfoQueryService;
import com.mycompany.dashboard.service.GpsInfoService;
 ...
 * 管理实体{@link com.mycompany.dashboard.domain.GpsInfo}的REST Controller。
 */
@RestController
@RequestMapping("/api")
@Api(value = "gps-infos", tags = "GPS信息API接口")
public class GpsInfoResource {
    ...
    @ApiOperation(value = "新建GPS信息", notes = "创建并返回一个新的GPS信息")
    ...
    @ApiOperation(value = "更新GPS信息", notes = "根据主键更新并返回一个更新后的GPS信息")
    public ResponseEntity<GpsInfoDTO> updateGpsInfo(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, gpsInfoDTO.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @ApiOperation(value = "部分更新GPS信息", notes = "根据主键及实体信息实现部分更新，值为null的属性将忽略，并返回一个更新后的GPS信息")
    ...
    public ResponseEntity<GpsInfoDTO> partialUpdateGpsInfo(
        ...
        if (gpsInfoRepository.findById(id).isEmpty()) {
            throw new BadRequestAlertException("Entity not found", ENTITY_NAME, "idnotfound");
        }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, gpsInfoDTO.getId().toString())
        );
    }
    ...
    @ApiOperation(value = "获取GPS信息分页列表", notes = "获取GPS信息的分页列表数据")
    ...
    @ApiOperation(value = "获取指定主键的GPS信息", notes = "获取指定主键的GPS信息信息")
    ...
    @ApiOperation(value = "GPS信息EXCEL导出", notes = "导出全部GPS信息为EXCEL文件")
    ...
    @ApiOperation(value = "GPS信息EXCEL导入", notes = "根据GPS信息EXCEL文件导入全部数据")
    ...
    @ApiOperation(value = "删除一个GPS信息", notes = "根据主键删除单个GPS信息")
    ...
    @ApiOperation(value = "删除多个GPS信息", notes = "根据主键删除多个GPS信息")
    ...
    @ApiOperation(value = "根据字段部分更新GPS信息", notes = "根据指定字段部分更新GPS信息，给定的属性值可以为任何值，包括null")
    ...
    @ApiOperation(value = "更新GPS信息单个属性", notes = "根据指定字段更新GPS信息，给定的属性值可以为任何值，包括null")
