...
import com.mycompany.dashboard.service.UploadImageService;
...
/**
 * REST controller for managing {@link com.mycompany.dashboard.domain.UploadImage}.
 */
@RestController
@RequestMapping("/api")
public class UploadImageResource {
    ...
    public ResponseEntity<Void> exportToExcel() throws IOException {
        IPage<UploadImageDTO> page = uploadImageService.findAll(null);
