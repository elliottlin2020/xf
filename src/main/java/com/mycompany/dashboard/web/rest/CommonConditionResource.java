...
import com.mycompany.dashboard.domain.CommonCondition;
import com.mycompany.dashboard.repository.CommonConditionRepository;
import com.mycompany.dashboard.service.CommonConditionQueryService;
import com.mycompany.dashboard.service.CommonConditionQueryService;
import com.mycompany.dashboard.service.CommonConditionService;
import com.mycompany.dashboard.service.criteria.CommonConditionCriteria;
import com.mycompany.dashboard.service.dto.CommonConditionDTO;
 ...
 * 管理实体{@link com.mycompany.dashboard.domain.CommonCondition}的REST Controller。
 */
@RestController
@RequestMapping("/api")
@Api(value = "common-conditions", tags = "通用条件API接口")
public class CommonConditionResource {
    ...
    @ApiOperation(value = "新建通用条件", notes = "创建并返回一个新的通用条件")
    ...
    @ApiOperation(value = "更新通用条件", notes = "根据主键更新并返回一个更新后的通用条件")
    public ResponseEntity<CommonConditionDTO> updateCommonCondition(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, commonConditionDTO.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @ApiOperation(value = "部分更新通用条件", notes = "根据主键及实体信息实现部分更新，值为null的属性将忽略，并返回一个更新后的通用条件")
    ...
    public ResponseEntity<CommonConditionDTO> partialUpdateCommonCondition(
        ...
        if (commonConditionRepository.findById(id).isEmpty()) {
            throw new BadRequestAlertException("Entity not found", ENTITY_NAME, "idnotfound");
        }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, commonConditionDTO.getId().toString())
        );
    }
    ...
    @ApiOperation(value = "获取通用条件分页列表", notes = "获取通用条件的分页列表数据")
    ...
    @ApiOperation(value = "获取指定主键的通用条件", notes = "获取指定主键的通用条件信息")
    ...
    @ApiOperation(value = "通用条件EXCEL导出", notes = "导出全部通用条件为EXCEL文件")
    ...
    @ApiOperation(value = "通用条件EXCEL导入", notes = "根据通用条件EXCEL文件导入全部数据")
    ...
    @ApiOperation(value = "删除一个通用条件", notes = "根据主键删除单个通用条件")
    ...
    @ApiOperation(value = "删除多个通用条件", notes = "根据主键删除多个通用条件")
    ...
    @ApiOperation(value = "根据字段部分更新通用条件", notes = "根据指定字段部分更新通用条件，给定的属性值可以为任何值，包括null")
    ...
    @ApiOperation(value = "更新通用条件单个属性", notes = "根据指定字段更新通用条件，给定的属性值可以为任何值，包括null")
