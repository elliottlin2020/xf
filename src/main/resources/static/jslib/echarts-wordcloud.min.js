  ...
  return (function(t) {
      ...
      function i(t, e, r) {
        ...
        for (var a in e)
          if (e.hasOwnProperty(a)) {
            var o = t[a],
              s = e[a];
            !S(s) || !S(o) || w(s) || w(o) || T(s) || T(o) || M(s) || M(o) || F(s) || F(o)
    ...
    function(t, e, r) {
      ...
      function u(t, e, r, n, i, o, s, l, h, u, c) {
        var f,
          ...
          x = 1 / 0;
        (k[0] = h), (k[1] = u);
        for (var w = 0; w < 1; w += 0.05) (C[0] = a(t, r, i, s, w)), (C[1] = a(e, n, o, l, w)), (g = y(k, C)) < x && ((f = w), (x = g));
        x = 1 / 0;
        for (var b = 0; b < 32 && !(m < S); b++)
          (d = f - m),
            ...
            d >= 0 && g < x
              ? ((f = d), (x = g))
              : ((P[0] = a(t, r, i, s, v)), (P[1] = a(e, n, o, l, v)), (p = y(P, k)), v <= 1 && p < x ? ((f = v), (x = p)) : (m *= 0.5));
    ...
    function(t, e, r) {
      ...
      function s(t, e, r, n, i, a, o) {
        var s = x(t, { rich: a, truncate: o, font: e, textAlign: r, textPadding: i }),
          u = s.outerWidth,
          c = s.outerHeight,
          f = l(0, u, r),
          d = h(0, c, n);
      ...
      function m(t, e, r, n) {
        ...
        if ((r && (s += r[0] + r[2]), t && n)) {
          ...
          if (null != l && s > l) (t = ''), (a = []);
            ...
            for (
              var u = f(h - (r ? r[1] + r[3] : 0), e, n.ellipsis, { minChar: n.minChar, placeholder: n.placeholder }), c = 0, v = a.length;
              c < v;
              c++
            )
              a[c] = d(a[c], u);
            ...
            if ('string' == typeof D && '%' === D.charAt(D.length - 1)) (M.percentWidth = D), u.push(M), (D = 0);
              ...
              null != z &&
                ...
                (!L || z < B
                  ...
                  : ((M.text = c(M.text, z - B, I, d.ellipsis, { minChar: d.minChar })),
                    (M.textWidth = i(M.text, I)),
                    (D = M.textWidth + B)));
            }
      ...
      (_.prototype = {
        ...
        _dashedLineTo: function(t, e) {
          var r,
            ...
            m = o.length;
          for (
            u /= f, c /= f, a < 0 && (a = i + a), a %= i, d -= a * u, p -= a * c;
            (u > 0 && d <= t) || (u < 0 && d >= t) || (0 == u && ((c > 0 && p <= e) || (c < 0 && p >= e)));
            ...
            (n = this._dashIdx),
              ...
              (u > 0 && d < l) ||
                ...
                (c > 0 && p < h) ||
                (c < 0 && p > h) ||
                s[n % 2 ? 'moveTo' : 'lineTo'](u >= 0 ? v(d, t) : g(d, t), c >= 0 ? v(p, e) : g(p, e));
        ...
        _dashedBezierTo: function(t, e, r, i, a, o) {
          ...
          for (d < 0 && (d = f + d), d %= f, s = 0; s < 1; s += 0.1)
            (l = y(p, t, r, a, s + 0.1) - y(p, t, r, a, s)), (h = y(m, e, i, o, s + 0.1) - y(m, e, i, o, s)), (w += x(l * l + h * h));
          for (; _ < b && !((S += v[_]) > d); _++);
          for (s = (S - d) / w; s <= 1; )
    ...
    function(t, e, r) {
      ...
      function m(t, e) {
        var r,
          ...
          a = t / i;
        return (
          (r = e ? (a < 1.5 ? 1 : a < 2.5 ? 2 : a < 4 ? 3 : a < 7 ? 5 : 10) : a < 1 ? 1 : a < 2 ? 2 : a < 3 ? 3 : a < 5 ? 5 : 10),
          (t = r * i),
      ...
      function x(t) {
        function e(t, r, n) {
          return (
            ...
            (t.interval[n] === r.interval[n] && (t.close[n] - r.close[n] == (n ? -1 : 1) || (!n && e(t, r, 1))))
          );
        }
        t.sort(function(t, r) {
          return e(t, r, 0) ? -1 : 1;
    ...
    function(t, e, r) {
      function n(t) {
        return isNaN(t)
          ? '-'
          : ((t = (t + '').split('.')), t[0].replace(/(\d{1,3})(?=(?:\d{3})+(?!\d))/g, '$1,') + (t.length > 1 ? '.' + t[1] : ''));
      }
      function i(t, e) {
        return (
    ...
    function(t, e, r) {
        ...
        if (t) {
          ...
          if ('#' !== n.charAt(0)) {
            ...
            if (4 === n.length) {
              ...
              return g >= 0 && g <= 4095
                ? (u(e, ((3840 & g) >> 4) | ((3840 & g) >> 8), (240 & g) | ((240 & g) >> 4), (15 & g) | ((15 & g) << 4), 1), f(t, e), e)
                : void u(e, 0, 0, 0, 1);
            }
            if (7 === n.length) {
              var g = parseInt(n.substr(1), 16);
              return g >= 0 && g <= 16777215
                ? (u(e, (16711680 & g) >> 16, (65280 & g) >> 8, 255 & g, 1), f(t, e), e)
                : void u(e, 0, 0, 0, 1);
            }
          }
        }
      ...
      function w(t, e, r, n) {
        if ((t = d(t)))
          return (t = g(t)), null != e && (t[0] = i(e)), null != r && (t[1] = s(r)), null != n && (t[2] = s(n)), b(v(t), 'rgba');
      }
      function _(t, e) {
    ...
    function(t, e, r) {
      ...
      function l(t, e, r, n, i) {
        ...
        for (var M = 0; M < r.lines.length; M++) {
          for (
            var T, k = r.lines[M], C = k.tokens, I = C.length, A = k.lineHeight, O = k.width, D = 0, L = _, F = S, R = I - 1;
      ...
      function u(t, e, r, n, i, a, o, s) {
        ...
        'top' === h ? (u = a + r.height / 2) : 'bottom' === h && (u = a + i - r.height / 2),
          !r.isLineHolder &&
            c(l) &&
            f(t, e, l, 'right' === s ? o - r.width : 'center' === s ? o - r.width / 2 : o, u - r.height / 2, r.width, r.height);
        var d = r.textPadding;
    ...
    function(t, e, r) {
      function n(t) {
        for (
          var e = t.getContext('2d'), r = e.getImageData(0, 0, t.width, t.height), n = e.createImageData(r), i = 0, a = 0, o = 0;
          o < r.data.length;
          o += 4
        ) {
          var s = r.data[o + 3];
        ...
        for (var h = i / a, o = 0; o < r.data.length; o += 4) {
          ...
          s < 128 || l > h
            ...
            : ((n.data[o] = 255), (n.data[o + 1] = 255), (n.data[o + 2] = 255), (n.data[o + 3] = 255));
        }
        ...
        t.eachSeriesByType('wordCloud', function(r) {
          function s(t) {
            ...
            t.detail.drawn &&
              ...
              ((t.detail.drawn.gx += l.x / m), (t.detail.drawn.gy += l.y / m), r.layoutInstance.ondraw(e[0], e[1], e[2], t.detail.drawn));
          }
    ...
    function(t, e, r) {
      ...
      function i(t, e, r) {
        ...
        return (
          ...
          { width: Math.max(s - a - r[1] - r[3], 0), height: Math.max(l - o - r[0] - r[2], 0) }
        );
      }
      function a(t, e, r) {
        r = g.normalizeCssArray(r || 0);
        ...
        switch (
          ...
          isNaN(u) && (u = i - l - c - o),
          null != p &&
            (isNaN(h) && isNaN(u) && (p > n / i ? (h = 0.8 * n) : (u = 0.8 * i)), isNaN(h) && (h = p * u), isNaN(u) && (u = h / p)),
          isNaN(a) && (a = n - s - h - d),
          isNaN(o) && (o = i - l - u - c),
          t.left || t.right)
        ) {
      ...
      function l(t, e, r) {
        function n(r, n) {
          ...
          if (
            ...
            return a(e, r[1]) ? (h[r[2]] = null) : a(e, r[2]) && (h[r[1]] = null), h;
          if (2 !== u && l) {
            if (l >= 2) return o;
    ...
    function(t, e, r) {
      ...
      function s(t, e) {
        ...
        return 'ordinal' === r
          ? t
          : ('time' === r && 'number' != typeof t && null != t && '-' !== t && (t = +_.parseDate(t)), null == t || '' === t ? NaN : +t);
      }
      function l(t, e) {
        var r = new b();
        return (
        ...
        return (
          S(e, function(t, n) {
            if (M(t)) {
              ...
              for (var i = 0; i < r.length; i++) {
                var a = r[i].exist;
                if (!(r[i].option || (null != a.id && null != t.id) || null == t.name || c(t) || c(a) || a.name !== t.name + ''))
          ...
          S(e, function(n, i) {
            ...
            if (
              !(
                ...
                null == n ||
                ('index' === l && 'none' === n) ||
                (r && r.includeMainTypes && y.indexOf(r.includeMainTypes, s) < 0)
              )
            ) {
              var h = { mainType: s };
              ('index' === l && 'all' === n) || (h[l] = n);
    ...
    function(t, e, r) {
      ...
      function s(t, e) {
        ...
        return (
          ...
          { x: t.x + t.width / 2 - i / 2, y: t.y + t.height / 2 - r / 2, width: i, height: r }
        );
      }
      function l(t, e) {
        if (t.applyTransform) {
      ...
      function A(t, e, r, n, i, a) {
        if (
          ...
          (t.textStroke = O(e.getShallow('textBorderColor'), n) || r.textBorderColor),
          (t.textStrokeWidth = Y.retrieve2(e.getShallow('textBorderWidth'), r.textBorderWidth)),
          !i)
        ) {
          if (a) {
      ...
      function D(t, e, r) {
        ...
        return (
          null == t.textFill &&
            !1 !== i &&
            (!0 === i || (r.isRectText && e && 'string' == typeof e && e.indexOf('inside') >= 0)) &&
            ((n = { textFill: null, textStroke: t.textStroke, textStrokeWidth: t.textStrokeWidth }),
            (t.textFill = '#fff'),
            null == t.textStroke && ((t.textStroke = r.autoColor), null == t.textStrokeWidth && (t.textStrokeWidth = 2))),
          n
        );
      }
      function L(t) {
    ...
    function(t, e, r) {
      ...
      function u(t, e, r, n, i, a, o, s, l) {
        ...
        if (1 == l) for (var u = 0; u < h; u++) s[u] = c(t[u], e[u], r[u], n[u], i, a, o);
          ...
          for (var f = t[0].length, u = 0; u < h; u++) for (var d = 0; d < f; d++) s[u][d] = c(t[u][d], e[u][d], r[u][d], n[u][d], i, a, o);
      }
          ...
          if (f || !O) {
            ...
            var Y = function(t, e) {
                ...
                if (0 !== n)
                  if (((z = (e - P[r]) / n), w))
                    if (
                      ((E = I[r]), (N = I[0 === r ? r : r - 1]), (W = I[r > _ - 2 ? _ - 1 : r + 1]), (q = I[r > _ - 3 ? _ - 1 : r + 2]), M)
                    )
              ...
              V = new p({ target: t._target, life: b, loop: t._loop, delay: t._delay, onframe: Y, ondestroy: r });
      ...
      n.prototype = {
        ...
        step: function(t, e) {
          ...
          if (!(r < 0)) {
            ...
            return (
              this.fire('frame', o), 1 == r ? (this.loop ? (this.restart(t), 'restart') : ((this._needsRemove = !0), 'destroy')) : null
            );
          }
        },
        restart: function(t) {
      ...
      var r = {
          ...
          elasticIn: function(t) {
            ...
            return 0 === t
              ...
              : 1 === t
              ? 1
              : (!r || r < 1 ? ((r = 1), (e = 0.1)) : (e = (0.4 * Math.asin(1 / r)) / (2 * Math.PI)),
                -r * Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * (2 * Math.PI)) / 0.4));
          },
          ...
          elasticInOut: function(t) {
            ...
            return 0 === t
              ...
              : (!r || r < 1 ? ((r = 1), (e = 0.1)) : (e = (0.4 * Math.asin(1 / r)) / (2 * Math.PI)),
                (t *= 2) < 1
                  ? r * Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * (2 * Math.PI)) / 0.4) * -0.5
                  : r * Math.pow(2, -10 * (t -= 1)) * Math.sin(((t - e) * (2 * Math.PI)) / 0.4) * 0.5 + 1);
          },
          backIn: function(t) {
            var e = 1.70158;
            return t * t * ((e + 1) * t - e);
    ...
    function(t, e) {
      function r(t, e, r, n, i, a) {
        ...
        var o = n < e ? 1 : -1,
          s = (a - e) / (n - e);
        return (1 !== s && 0 !== s) || (o = n < e ? 0.5 : -0.5), s * (r - t) + t > i ? o : 0;
      }
      t.exports = r;
    },
    function(t, e) {
      ...
      function i(t, e) {
        ...
        for (var s = 0; s < l; s++) {
          var h,
            ...
            g = t[d % r];
          e
            ? ((h = t[(d - 1 + r) % r]), (u = t[(d + 1) % r]), (c = t[(d + 2) % r]))
            : ((h = t[0 === d ? d : d - 1]), (u = t[d > r - 2 ? r - 1 : d + 1]), (c = t[d > r - 3 ? r - 1 : d + 2]));
          var p = v * v,
            m = v * p;
    ...
    function(t, e, r) {
      function n(t, e, r) {
        ...
        return null === n || null === i
          ? [(r ? f : u)(t.x1, t.cpx1, t.cpx2, t.x2, e), (r ? f : u)(t.y1, t.cpy1, t.cpy2, t.y2, e)]
          : [(r ? c : h)(t.x1, t.cpx1, t.x2, e), (r ? c : h)(t.y1, t.cpy1, t.y2, e)];
      }
      var i = r(1),
        a = r(2),
        o = r(4),
        ...
        v = i.extend({
          ...
          buildPath: function(t, e) {
            ...
            0 !== f &&
              (t.moveTo(r, n),
              null == u || null == c
                ? (f < 1 && (s(r, o, i, f, d), (o = d[1]), (i = d[2]), s(n, h, a, f, d), (h = d[1]), (a = d[2])),
                  t.quadraticCurveTo(o, h, i, a))
                : (f < 1 &&
                    (l(r, o, u, i, f, d), (o = d[1]), (u = d[2]), (i = d[3]), l(n, h, c, a, f, d), (h = d[1]), (c = d[2]), (a = d[3])),
              ...
              if (a) {
                ...
                var b,
                    ...
                    for (0 === t && i.push([f[0], f[1], 0]); r--; ) {
                      ...
                      'circle' !== n.shape && (a = n.shape((r / e) * 2 * Math.PI)),
                        i.push([
                          ...
                          f[1] + t * a * Math.sin((-r / e) * 2 * Math.PI) * n.ellipticity,
                          (r / e) * 2 * Math.PI
                        ]);
                    }
                    return (P[t] = i), i;
                  ...
                  B = function(e, r, i, a, o, s) {
                    ...
                    if (S) {
                      var v = o.bounds;
                      d = { x: (e + v[3]) * p, y: (r + v[0]) * p, w: (v[1] - v[3] + 1) * p, h: (v[2] - v[0] + 1) * p };
                    }
                      ...
                      for (var v = 0; v < f.length; v++) {
                        var g = (function(n) {
                          ...
                          return (
                            ...
                            (F(s, l, o, e, r, d - h, n[2], a, i), B(s, l, 0, 0, o, t), { gx: s, gy: l, rot: a, info: o })
                          );
                        })(f[v]);
                        if (g) return g;
                      }
                ...
                !(function() {
                  ...
                  if (N('wordcloudstart', !0)) {
                    ...
                    0 !== n.wait
                      ...
                      : ((y = window.setImmediate), (w = window.clearImmediate));
                    var _ = function(e, r) {
                        t.forEach(function(t) {
                    ...
                    var P = y(function t() {
                      ...
                      v = new Date().getTime();
                      var e = z(n.list[o]),
                        r = !N('wordclouddrawn', !0, { item: n.list[o], drawn: e });
